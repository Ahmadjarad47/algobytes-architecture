...
{
    /// <inheritdoc />
    public partial class AddSalesOrdersPaymentsWalletTransactions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExchangeRateUsedToBase = table.Column<decimal>(type: "numeric(18,6)", precision: 18, scale: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<long>(type: "bigint", nullable: false),
                    CurrencyCode = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    GatewayName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
